...
public class GraphqlserverApplication {
    ...
    ApplicationRunner applicationRunner(AuthorRepository authorRepository, BookRepository bookRepository) {
        return args -> {
            ...
            bookRepository.saveAll(List.of(new Book("Reactive Java", "Good Books", josh), new Book("Simple Java", "Good Reads", josh), new Book("Native Java", "Book Publishing Co", mark)));
        };
    }
}